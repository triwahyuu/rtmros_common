...
macro (generate_default_launch_eusinterface_files wrlfile project_pkg_name)
  ...
  if (NOT "${ARGV3}" STREQUAL "--no-toplevel-launch")
    ...
    add_dependencies(${_sname}_${PROJECT_NAME}_compile ${_sname}_${PROJECT_NAME}_compile_top_launch)
  endif()
  ...
  if (NOT "${ARGV3}" STREQUAL "--no-euslisp")
    ...
    add_dependencies(${_sname}_${PROJECT_NAME}_compile ${_sname}_${PROJECT_NAME}_compile_eusif)
  endif()
endmacro ()
